...
configure_arr_stack() {
  ...
  ensure_root_folder "Radarr" "${RADARR_PORT:-7878}" "$radarr_key" "/data/movies"
  ensure_root_folder "Sonarr" "${SONARR_PORT:-8989}" "$sonarr_key" "/data/tv"
...
SONARR_ROOT_FOLDER="${SONARR_ROOT_FOLDER:-/data/tv}"
...
main() {
  ...
  echo ""
  echo "Dicas:"
  echo "  • Plex: bibliotecas /data/tv e /data/movies + PLEX_CLAIM no .env"
